...
public class AcessoSociedade implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (usuario.getCategoriaUsuario().equals(CategoriaUsuario.Sociedade) || usuario.getCategoriaUsuario().equals(CategoriaUsuario.Atendimento) || usuario.getCategoriaUsuario().equals(CategoriaUsuario.Gerencia)) {
