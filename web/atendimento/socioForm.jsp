            ...
            <jsp:include page="/carregar/menu.jsp"></jsp:include>
                ...
                <div class="fields">
                    <div class="eight wide field required">
                        <label>Sócio</label>
                        <input type="text" value="${socio.nomeSocio}" name="nomeSocio" id="nomeSocio">
                    </div>
                ...
                <div class="fields">
                    ...
                    <div class="five wide field required">
                        <label>CPF</label>
                        <input type="text" value="${socio.cpfSocio}" name="cpfSocio" id="cpf">
                    </div>

                    <div class="three wide field required">
                        <label>Nascimento</label>
                        <input type="date" value="${socio.nascimentoSocio}" name="nascimentoSocio" id="nascimentoSocio">
                    </div>

                    <div class="four wide field required">
                        <label>Sexo</label>
                        <select class="ui dropdown" name="sexoSocio">
                    ...
                    <div class="four wide field required">
                        ...
                        <select class="ui dropdown" name="estadoCivilSocio" id="estadoCivilSocio">
                ...
                <div class="fields">
                    ...
                    <div class="four wide field required">
                        ...
                        <input type="text" value="${socio.telefone1}" name="telefone1" id="telefone1">
                    </div>

                    <div class="four wide field">
                        <label>Telefone Alternativo 1</label>
                        <input type="text" value="${socio.telefone2}" name="telefone2">
                    </div>

                    <div class="four wide field">
                        <label>Telefone Alternativo 2</label>
                        <input type="text" value="${socio.telefone3}" name="telefone3">
                    </div>

                    <div class="four wide field required">
                        <label>E-mail</label>
                        <input type="text" value="${socio.usuarioSocio.email}" name="email" id="email">
                    </div>
                ...
                <div class="fields">
                    ...
                    <div class="four wide field required">
                        ...
                        <input type="text" value="${socio.profissao}" name="profissao" id="profissao">
                    </div>

                    <div class="four wide field required">
                        <label>Nacionalidade</label>
                        <input type="text" value="${socio.nacionalidadeSocio}" name="nacionalidadeSocio" id="nacionalidadeSocio">
                    </div>

                    <div class="four wide field required">
                        <label>Naturalidade</label>
                        <input type="text" value="${socio.naturalidadeSocio}" name="naturalidadeSocio" id="naturalidadeSocio">
                    </div>
                ...
                <div class="fields">
                    ...
                    <div class="eight wide field required">
                        ...
                        <input type="text" value="${socio.logradouro}" name="logradouro" id="logradouro">
                    </div>

                    <div class="two wide field required">
                        <label>Número</label>
                        <input type="text" value="${socio.numero}" name="numero" id="numero">
                    </div>

                    <div class="two wide field required">
                        <label>CEP</label>
                        <input type="text" value="${socio.cep}" name="cep" id="cep">
                    </div>

                    <div class="four wide field required">
                        <label>UF</label>
                        <select class="ui dropdown" name="uf" id="uf">
                ...
                <div class="fields">
                    ...
                    <div class="four wide field required">
                        ...
                        <input type="text" value="${socio.municipio}" name="municipio" id="municipio">
                    </div>

                    <div class="four wide field required">
                        <label>Bairro</label>
                        <input type="text" value="${socio.bairro}" name="bairro" id="bairro">
                    </div>

                    <div class="eight wide field">
                        <label>Complemento</label>
                        <input type="text" value="${socio.complemento}" name="complemento">
                    </div>

                </div>

                <button class="ui inverted green submit button" id="submit" type="submit" name="action" value="Socio.SalvaSocio">Salvar</button>
