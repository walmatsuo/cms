        ...
        <body>
            ...
            <form id="formularioSocioPorMes" class="ui form segment" action="/CMS/GerenciaController" method="POST">
                <h4 class="ui horizontal header divider">
                    ...
                    Relatório - Dependente por Parentesco
                </h4>
                    ...
                    <div class="four wide field required">
                        ...
                        <select class="ui dropdown" name="parentesco">
                            ...
                            <c:forEach items="${listaParentesco}" var="parentesco">
                                <option value="${parentesco.idParentesco}">${parentesco.nomeParentesco}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>

                <button class="ui inverted green submit button" id="submit" type="submit" name="action" value="Relatorio.DependentePorParentesco">Gerar</button>
